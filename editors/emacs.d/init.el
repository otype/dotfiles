...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (magit which-key mwim company-go nlinum gotest ag go-guru neotree solarized-theme atom-one-dark go-mode company counsel-projectile avy general use-package))))
(custom-set-faces
