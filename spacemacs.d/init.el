...
you should place your code here."
  ...
  ;; highlight color for current line (especially in theme 'flatland')
  (global-hl-line-mode 1)
  (set-face-background 'hl-line "#41494E")
  (set-face-attribute 'region nil :background "#515B63" :foreground "#E7FFB7")
...
(custom-set-faces
 ...
 ;; Your init file should contain only one such instance.
 ;; If there is more than one, they won't work right.
 '(default ((t (:family "Meslo LG S for Powerline" :foundry "nil" :slant normal :weight normal :height 140 :width normal)))))
